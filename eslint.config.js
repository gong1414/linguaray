 ...
 *  3. The React tree (src/** outside bridge) must never import Solid or the
 *     legacy self-built kit.
...
export default tseslint.config(
  { ignores: ["**/node_modules/**", "**/dist/**", "**/target/**", "**/.storybook-static/**", "**/coverage/**"] },
  ...
  {
    // The bridge IS the choke point — it may import @tauri-apps. Placed LAST so
    // the src-wide hygiene blocks above cannot re-restrict it.
