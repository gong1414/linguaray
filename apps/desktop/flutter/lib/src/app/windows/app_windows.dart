...
import '../navigation/settings_navigation.dart';

export '../../platform/windows/window_positioning.dart'
    show
...
export '../navigation/settings_navigation.dart' show SettingsDestination;
