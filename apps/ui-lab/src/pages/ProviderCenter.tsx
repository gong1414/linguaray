...
function initialProviders(): ProviderProfileFE[] {
  return [
    ...
    { uuid: "mock-google", template_id: "google", name: "Google Translate", protocol: "google_translate", endpoint: "https://translation.googleapis.com/", model: null, enabled: true, sort_order: 3, is_local: false, needs_key: false, secret_ref: "", capabilities: CAPS_TRAD, status: "active", version: 1, hasKey: false },
