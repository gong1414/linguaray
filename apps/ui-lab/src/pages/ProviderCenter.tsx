              ...
              <For each={sortedProviders()}>
                {(p, index) => (
                  ...
                  >
                    ...
                    {/* Main row: [handle | card | reorder]. Reorder arrows are
                        OUTSIDE the card (on the row's right edge) so they never
                        get clipped by the card's action-bar overflow. */}
                    <div class="pc__provider-main">
                      ...
                      />
                      {/* Reorder arrows — outside the card, on the row's right.
                          Vertical stack so they take minimal horizontal space. */}
