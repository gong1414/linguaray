...
open class RuntimeSettings: RuntimeSettingsProtocol, @unchecked Sendable {
   ...
   * to settings or returned by `list_providers` / `get_json`.
   */
  open func setProviderSecrets(providerId: String, secrets: [String: String]) async throws {
    return
      try await uniffiRustCallAsync(
        rustFutureFunc: {
...
public protocol RuntimeTextExtractorProtocol: AnyObject, Sendable {
   ...
   */
  func extractFromScreenSelectionDetailed() async throws -> SelectionExtraction
...
open class RuntimeTextExtractor: RuntimeTextExtractorProtocol, @unchecked Sendable {
   ...
   * warnings. The clipboard is restored before this future completes.
   */
  open func extractFromScreenSelectionDetailed() async throws -> SelectionExtraction {
    return
      try await uniffiRustCallAsync(
        rustFutureFunc: {
...
public struct SelectionExtraction: Equatable, Hashable {
   ...
   */
  public var recoverableError: String?

  // Default memberwise initializers are never public by default, so we
  // declare one manually.
  public init(
    text: String, readMethod: String,
    /**
     * A non-fatal warning, most commonly a clipboard snapshot/restore issue.
     */
...
#if compiler(>=6)
  extension SelectionExtraction: Sendable {}
#endif

#if swift(>=5.8)
  @_documentation(visibility: private)
#endif
public struct FfiConverterTypeSelectionExtraction: FfiConverterRustBuffer {
  public static func read(from buf: inout (data: Data, offset: Data.Index)) throws
    -> SelectionExtraction
  {
    return
      try SelectionExtraction(
        text: FfiConverterString.read(from: &buf),
        readMethod: FfiConverterString.read(from: &buf),
        recoverableError: FfiConverterOptionString.read(from: &buf)
      )
  }

  public static func write(_ value: SelectionExtraction, into buf: inout [UInt8]) {
    FfiConverterString.write(value.text, into: &buf)
    FfiConverterString.write(value.readMethod, into: &buf)
    FfiConverterOptionString.write(value.recoverableError, into: &buf)
  }
}
  ...
  @_documentation(visibility: private)
#endif
public func FfiConverterTypeSelectionExtraction_lift(_ buf: RustBuffer) throws
  -> SelectionExtraction
{
  return try FfiConverterTypeSelectionExtraction.lift(buf)
}

#if swift(>=5.8)
  @_documentation(visibility: private)
#endif
public func FfiConverterTypeSelectionExtraction_lower(_ value: SelectionExtraction) -> RustBuffer {
  return FfiConverterTypeSelectionExtraction.lower(value)
}
