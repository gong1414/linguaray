/**
 * Updater panel copy (zh/en), mirroring privacy-copy.ts conventions.
 * The privacy note is load-bearing: the startup check is the app's ONLY
 * unsolicited network request and must stay disclosed here.
 */
...
export const UPDATER_COPY: Record<Locale, UpdaterCopy> = { en, zh };
