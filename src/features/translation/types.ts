/**
 * Frontend translation state model. The single source of truth consumed by the
 * translation popup and the input window.
 *
...
/** Discriminant union for all popup/input translation states. */
...
/** i18n copy keys for the selection popup + the input window. */
export type CopyKey =
  | "selection.loading"
