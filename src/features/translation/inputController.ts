...
/**
 * Load the provider name map once (idempotent). Returns a Promise that resolves
 * when the map is populated (or immediately if already loaded). The caller
 * awaits this before rendering results so card labels resolve synchronously.
 */
