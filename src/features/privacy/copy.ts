...
export const PRIVACY_COPY: Record<Locale, PrivacyCopy> = {
  en: {
    ...
    historyDisabledNotice:
      "When off, new translations are not stored. Existing encrypted history is retained until you clear it.",
    ...
    externalHint: "Local HTTP API for scripts. Off by default; enabling it exposes translations on this machine only.",
    ...
    externalTokenHint:
      "Bearer token for the local API. It is shown ONCE; store it in your password manager.",
  ...
  zh: {
    ...
    externalHint: "供本地脚本使用的 HTTP API，默认关闭；开启后仅暴露给本机。",
    ...
    externalTokenHint: "本机 API 的 Bearer 令牌，只显示这一次，请存入密码管理器。",
    copyToken: "复制令牌",
    copied: "已复制",
    dismissToast: "关闭",
  },
